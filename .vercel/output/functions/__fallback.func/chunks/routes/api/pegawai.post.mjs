...
const pegawai_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const idPegawai = result.insertId;
    ...
    await conn.commit();
    await logActivity(event, "Tambah Pegawai", `Menambahkan pegawai ${body.nama_pegawai} (NIP: ${body.nip})`, auth == null ? void 0 : auth.id);
...
export { pegawai_post as default };
//# sourceMappingURL=pegawai.post.mjs.map
