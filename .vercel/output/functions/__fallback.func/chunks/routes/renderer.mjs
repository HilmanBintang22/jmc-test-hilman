...
import { m as joinRelativeURL, v as useRuntimeConfig, i as getResponseStatusText, h as getResponseStatus, e as encodePath, a as defineRenderHandler, f as getQuery, c as createError, b as destr, j as getRouteRules, n as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.png"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
