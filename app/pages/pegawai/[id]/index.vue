            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                <div class="datagrid-item">
                  ...
                  <div class="datagrid-content">{{ formatDate(pegawai.tanggal_lahir) }}</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="datagrid-item">
              ...
              <div class="col-md-6">
                <div class="datagrid-item">
                  ...
                  <div class="datagrid-content" v-for="p in pegawai.pendidikan || []" :key="p.id">
                    {{ p.tingkat_pendidikan || '-' }} / {{ p.nama_sekolah || '-' }} / {{ p.tahun_lulus || '-' }}
                  </div>
                  <div class="datagrid-content" v-if="!pegawai.pendidikan?.length">-</div>
                </div>
              </div>
              <div class="col-12">
                <div class="datagrid-item">
            ...
            <div class="row g-4">
              <div class="col-12">
                <div class="datagrid-item">
                  ...
                  <div class="datagrid-content">{{ formatDate(pegawai.tanggal_masuk) }}</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="datagrid-item">
                  <div class="datagrid-title">Jabatan</div>
                  <div class="datagrid-content">{{ pegawai.jabatan || '-' }}</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="datagrid-item">
                  <div class="datagrid-title">Departemen</div>
                  <div class="datagrid-content">{{ pegawai.departemen || '-' }}</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="datagrid-item">
                  <div class="datagrid-title">Jarak Rumah-Kantor</div>
                  <div class="datagrid-content">{{ pegawai.jarak_rumah_kantor || '-' }} km</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="datagrid-item">
